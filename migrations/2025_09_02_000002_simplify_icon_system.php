...
return [
    'up' => function (Builder $schema) {
        ...
        if ($schema->hasTable('wusong8899_funds_withdrawal_platforms')) {
            ...
            $schema->table('wusong8899_funds_withdrawal_platforms', function (Blueprint $table) use ($schema) {
                if (
                    $schema->hasColumn('wusong8899_funds_withdrawal_platforms', 'platform_specific_icon_url') &&
                ...
                if (
                    $schema->hasColumn('wusong8899_funds_withdrawal_platforms', 'platform_specific_icon_class') &&
        ...
        if ($schema->hasTable('wusong8899_funds_deposit_platforms')) {
            ...
            $schema->table('wusong8899_funds_deposit_platforms', function (Blueprint $table) use ($schema) {
                if (
                    $schema->hasColumn('wusong8899_funds_deposit_platforms', 'platform_specific_icon_url') &&
                    !$schema->hasColumn('wusong8899_funds_deposit_platforms', 'platform_icon_url')
                ) {
                    $table->renameColumn('platform_specific_icon_url', 'platform_icon_url');
                }
                if (
                    $schema->hasColumn('wusong8899_funds_deposit_platforms', 'platform_specific_icon_class') &&
