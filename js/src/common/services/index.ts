...
export const Services = {
  withdrawal: () =>
    import("./WithdrawalService").then((m) => m.withdrawalService),
 ...
 */
export async function getService<T = any>(
...
export async function initializeServices(): Promise<void> {
  try {
    ...
    console.log(
      "Available services: Withdrawal, Deposit, Platform, Settings, Address"
    );
  } catch (error) {
 ...
 */
export function checkServiceCapabilities(
  operation: string
): Record<string, boolean> {
  return {
    funds:
      typeof withdrawalService[operation as keyof typeof withdrawalService] ===
      "function",
    deposit:
      typeof depositService[operation as keyof typeof depositService] ===
      "function",
    platform:
      typeof platformService[operation as keyof typeof platformService] ===
      "function",
    settings:
      typeof settingsService[operation as keyof typeof settingsService] ===
      "function",
    address:
      typeof addressService[operation as keyof typeof addressService] ===
      "function",
  };
}
...
export function getServiceStats() {
  return {
    ...
    capabilities: {
      crud:
        checkServiceCapabilities("find").funds &&
        checkServiceCapabilities("create").deposit,
