...
export default class DepositPlatformManagementSection extends Component<DepositPlatformManagementSectionAttrs> {
  ...
  private handleEdit(platform: GenericPlatform): void {
    ...
    const depositPlatform: DepositPlatform = {
      ...
      platformIconUrl: typeof platform.platformIconUrl === 'function' ? platform.platformIconUrl() : platform.platformIconUrl,
      platformIconClass: typeof platform.platformIconClass === 'function' ? platform.platformIconClass() : platform.platformIconClass,
      warningText: '',
